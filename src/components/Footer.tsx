      ...
      <footer className="bg-surface border-t border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              <Link href="/" className="inline-flex items-center gap-2.5 mb-5">
                ...
                <div>
                  ...
                  <div className="text-muted text-[9px] tracking-[0.2em] uppercase mt-0.5">Technologies</div>
                </div>
              </Link>
              ...
              <div className="flex gap-2">
                {[FaLinkedin, FaTwitter, FaYoutube, FaGithub].map((Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="w-8 h-8 bg-white border border-border rounded-lg flex items-center justify-center text-gray-400 hover:text-primary hover:border-gray-300 transition-all duration-150"
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {navItems.slice(0, 5).map((item) => (
                  <li key={item.href}>
                    <Link href={item.href} className="text-sm text-gray-500 hover:text-heading transition-colors duration-150">
                      {item.label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {["Camouflage Nets", "Sniper Suits", "Thermal Paint", "Radar Coating", "Shelter Systems"].map((item) => (
                  <li key={item}>
                    <Link href="/products" className="text-sm text-gray-500 hover:text-heading transition-colors duration-150">
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-gray-500">
                ...
                <li className="pt-1">
                  <Link href="/contact" className="text-secondary hover:text-secondary-dark font-medium transition-colors duration-150">
                    Get in Touch →
                  </Link>
                </li>
              </ul>
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-xs text-gray-400">© {new Date().getFullYear()} Hyper Stealth Technologies. All rights reserved.</p>
            <div className="flex gap-5 text-xs text-gray-400">
              <a href="#" className="hover:text-heading transition-colors duration-150">Privacy Policy</a>
              <a href="#" className="hover:text-heading transition-colors duration-150">Terms of Service</a>
              <a href="#" className="hover:text-heading transition-colors duration-150">Security</a>
            </div>
          </div>
        </div>
      </footer>
