  ...
  export default function Home() {
    return (
      <>
        ...
        {/* Technology */}
        <section className="py-32 px-6 lg:px-10 bg-surface">
          <div className="max-w-7xl mx-auto">
            <SectionTitle
            ...
            <div className="mt-10 text-center">
              <Link
                href="/technology"
                className="inline-flex items-center gap-1.5 text-sm font-medium text-secondary hover:text-secondary-dark transition-colors duration-150"
              >
        ...
        <section className="py-32 px-6 lg:px-10 bg-surface">
          <div className="max-w-7xl mx-auto">
            <SectionTitle
              ...
              description="State-of-the-art manufacturing facilities delivering defense-grade quality with unmatched consistency."
            />
